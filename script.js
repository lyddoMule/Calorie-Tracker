class CalorieTracker {
    ...
    _displayMeal(meal) {
      ...
      <div  class="card-body p-1 ">   
         <div class="d-flex align-items-center justify-content-between">
             <h5>${meal.name}</h5>
             <div class="btn  btn-lightLime  text-light text-center fw-bold "> ${meal.calories}</div>
             <button class="delete btn btn-sm ">             <i class="bi bi-x bg-danger   text-light"></i>
</button>
         </div>    
     </div>`
    ...
    _displayWorkout(workout) {
      ...
      <div  class="card-body p-1 ">   
         <div class="d-flex align-items-center justify-content-between">
             <h5>${workout.name}</h5>
             <div class="btn  btn-lightLime  text-light text-center fw-bold "> ${workout.calories}</div>
                      <i class="bi bi-x delete bg-danger   text-light"></i>
         </div>    
     </div>`
